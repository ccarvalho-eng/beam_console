defmodule BeamConsoleDemoWeb.CoreComponents do
  @moduledoc """
  ...
  @doc "Returns a LiveView JS command that reveals the selected element."
  ...
  @doc "Returns a LiveView JS command that hides the selected element."
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(BeamConsoleDemoWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(BeamConsoleDemoWeb.Gettext, "errors", msg, opts)
    # end
